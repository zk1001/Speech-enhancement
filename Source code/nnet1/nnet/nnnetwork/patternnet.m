...
%
%  For an introduction use the Neural Pattern Recognition app <a href="matlab: doc nprtool">nprtool</a>.
%  Click <a href="matlab:nprtool">here</a> to launch it.
%
%  Pattern recognition networks can be trained to classify inputs according
%  to target classes.
%
%  <a href="matlab:doc patternnet">patternnet</a>(hiddenSizes,trainFcn,performFcn) takes a row vector of
%  N hidden layer sizes and a backpropagation training function and
...
%  The default arguments are (10,'<a href="matlab:doc trainscg">trainscg</a>','<a href="matlab:doc crossentropy">crossentropy</a>').
%
...
function net = create_network(param)
  ...
  net.performFcn = param.performFcn;
  net.outputs{numel(param.hiddenSizes)+1}.processParams{2}.ymin = 0;
