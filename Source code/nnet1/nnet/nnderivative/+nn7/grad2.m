function [gB,gIW,gLW,gA]=grad2(net,P,PD,BZ,IWZ,LWZ,N,Ac,gE,Q,TS,hints)
%CALCGRAD Calculate bias and weight performance gradients.
%
%	Synopsis
%
%	  [gB,gIW,gIW,gA] = nnprop.grad(net,P,PD,BZ,IWZ,LWZ,N,Ac,gE,Q,TS)
%
%	Warning!!
%
...
for i=hints.bpLayerOrder
  ...
  % ...through Layer Weights with zero delays
  Ne = [N{i,:}];
