function [perf,vperf,tperf,trainData,gB,gIW,gLW,gA,gradient] = perfs_sig_grad(net,trainData,valData,testData,needGradient,fcns)
...
if needGradient
  ...
  gB = cell(net.numLayers,trainData.TS);
  gIW = cell(net.numLayers,net.numInputs,trainData.TS);
  gLW = cell(net.numLayers,net.numLayers,trainData.TS);
  gA = cell(net.numLayers,trainData.TS);
  gradient = NaN;
end
