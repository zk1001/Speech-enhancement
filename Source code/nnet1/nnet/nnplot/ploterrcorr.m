...
%
% <a href="matlab:doc ploterrcorr">ploterrcorr</a>(errors) takes error data and plots its autocorrelation.
%
...
%
% The autocorrelation at lag 0 is equal to the mean squared error.
%
