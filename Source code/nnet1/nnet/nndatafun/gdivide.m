function c = gdivide(a,b)
%GDIVIDE Generalized right division.
%
% <a href="matlab:doc gdivide">gdivide</a>(a,b) returns a ./ b, supporting built in data behavior, as well as
% generalized behavior such as element-by-element and recursive division
...
%
% Here are examples of division with generalized behavior:
%
%   <a href="matlab:doc gdivide">gdivide</a>([1 2 3; 4 5 6],[10;20])
%   <a href="matlab:doc gdivide">gdivide</a>({1 2; 3 4},{1 3; 5 2})
%   <a href="matlab:doc gdivide">gdivide</a>({1 2 3 4},{10;20;30})
%
% See also GADD, GSUBTRACT, GMULTIPLY, GNEGATE.
