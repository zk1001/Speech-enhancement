function a = hardlims(n,varargin)
%HARDLIMS Symmetric hard limit transfer function.
%	
% Transfer functions convert a neural network layer's net input into
% its net output.
%	
% A = <a href="matlab:doc hardlims">hardlims</a>(N) takes an SxQ matrix of S N-element net input column
...
%
%   n = [0; 1; -0.5; 0.5];
%   a = <a href="matlab:doc hardlims">hardlims</a>(n);
%
% Here is a plot of this transfer function:
%
%   n = -5:0.01:5;
%   plot(n,<a href="matlab:doc hardlims">hardlims</a>(n))
