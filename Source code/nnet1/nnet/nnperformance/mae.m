function perf = mae(net,varargin)
%MAE Mean absolute error performance function.
%
%  <a href="matlab:doc mae">mae</a>(net,targets,outputs,errorWeights,...parameters...) calculates a
...
%
%    perf = <a href="matlab:doc mae">mae</a>(net,targets,outputs,{1},'regularization',0.1)
%
%  To setup a network to us the same performance measure during training:
%
%    net.<a href="matlab:doc nnproperty.net_performFcn">performFcn</a> = '<a href="matlab:doc mae">mae</a>';
