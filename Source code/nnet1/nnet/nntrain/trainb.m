...
for epoch=0:param.epochs
    ...
    elseif (current_time >= param.time)
        ...
        net = best.net;
    elseif (gradient <= param.min_grad)
        tr.stop = message('nnet:trainingStop:MinimumGradientReached');
        net = best.net;
    ...
    feedback.update(net,tr,options,data,[],[],best.net,status,statusValues);
    ...
    % Track Best Network
    [best,tr,val_fail] = nnet.train.trackBestNetwork(best,tr,val_fail,net,perf,vperf,epoch);
end
end
