function [out1,out2] = trainbuwb(varargin)
%TRAINBUWB Unsupervised batch training with weight & bias learning rules.
%
%  <a href="matlab:doc trainbuwb">trainbuwb</a> trains a network with unsupervised weight and bias learning
%  rules with batch updates. The weights and biases are updated at the end
%  of an entire pass through the input data.
%
%  [NET,TR] = <a href="matlab:doc trainbuwb">trainbuwb</a>(NET,X) takes a network NET, input data X
%  and returns the network after training it, and training record TR.
%
%  [NET,TR] = <a href="matlab:doc trainbuwb">trainbuwb</a>(NET,X,{},Xi,Ai,EW) takes additional optional
...
%
%    net.<a href="matlab:doc nnproperty.net_trainFcn">trainFcn</a> = 'trainbuwb';
