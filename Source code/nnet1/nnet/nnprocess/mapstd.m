...
%  
% <a href="matlab:doc mapstd">mapstd</a> processes input and target data by mapping its mean and standard 
% deviations to 0 and 1 respectively.
%
% [Y,settings] = <a href="matlab:doc mapstd">mapstd</a>(X) takes a matrix and returns it transformed with
% the settings used to perform the transform.
%
