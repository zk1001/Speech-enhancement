...
%
% <a href="matlab:doc removeconstantrows">removeconstantrows</a> processes input and target data by removing rows with
% constant values. Constant values do not provide a network with any
% information and can cause numerical problems for some algorithms.
%
% [Y,settings] = <a href="matlab:doc removeconstantrows">removeconstantrows</a>(X) takes a matrix and returns it 
% transformed with the settings used to perform the transform.
%
