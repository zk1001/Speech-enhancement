...
%  
% <a href="matlab:doc processpca">processpca</a> processes data so that the rows become uncorrelated and are
% ordered in terms of their contribution to total variation. In addition,
% rows whose contribution is too weak may be removed.
%
% [Y,settings] = <a href="matlab:doc processpca">processpca</a>(X) takes a matrix of data and returns it 
% transformed with the settings used to make the transform.
%
