...
% from the data.
%
% [Y,settings] = <a href="matlab:doc removerows">removerows</a>(X,'ind',rowIndices) takes a matrix and returns
% it with the specified rows removed, and also returns the settings used to
