...
%NTSTOOL.NARX Neural Network Time Series app - NAR Network
%
%  Syntax
%    
%    ntstool
...
try
  ...
  switch command
    ...
    case 'generateTrainScriptSimple'
      code = generateSimpleScript(nnet.genscript.NARXScriptGenerator(STATE));
      code = nnet.text.text2str(code);
      nnet.genscript.sendToEditor(code);
      
    case 'generateTrainScriptAdvanced'
      code = generateAdvancedScript(nnet.genscript.NARXScriptGenerator(STATE));
      code = nnet.text.text2str(code);
      nnet.genscript.sendToEditor(code);
