...
%NTSTOOL.IO Neural Network Time Series app - Input Output
%
%  Syntax
%    
%    ntstool
...
try
  ...
  switch command
    ...
    case 'generateTrainScriptSimple'
      code = generateSimpleScript(nnet.genscript.TimeDelayScriptGenerator(STATE));
      code = nnet.text.text2str(code);
      nnet.genscript.sendToEditor(code);
      
    case 'generateTrainScriptAdvanced'
      code = generateAdvancedScript(nnet.genscript.TimeDelayScriptGenerator(STATE));
      code = nnet.text.text2str(code);
      nnet.genscript.sendToEditor(code);
