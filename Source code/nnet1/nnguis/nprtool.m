...
try
  ...
  switch command
    ...
    case 'generateTrainScriptSimple'
      code = generateSimpleScript(nnet.genscript.PatternRecognitionScriptGenerator(STATE));
      code = nnet.text.text2str(code);
      nnet.genscript.sendToEditor(code);
      
    case 'generateTrainScriptAdvanced'
      code = generateAdvancedScript(nnet.genscript.PatternRecognitionScriptGenerator(STATE));
      code = nnet.text.text2str(code);
      nnet.genscript.sendToEditor(code);
