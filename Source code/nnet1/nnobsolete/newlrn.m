...
%  Syntax
%
%    net = newlrn(P,T,[S1...S(N-1)],{TF1...TFN},BTF,BLF,PF,IPF,OPF,DDF)
%
%  Description
%    
%     NET = NEWLRN(P,T,[S1...S(N-1)],{TF1...TFN},BTF,BLF,PF,IPF,OPF,DDF) takes,
...
%    and returns an N-layer Layered-Recurrent network.
%
...
%    and has one hidden layer with 10 neurons.
%
%      net = newlrn(P,T,10);
%
...
% Mark Beale, Orlando De Jesus, Martin Hagan, 7-20-05 
