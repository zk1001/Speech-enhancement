...
%   This function is designed to be used in a Simulink S-function block.
...
if length (ax)~=4
  nnerr.throw('Control',['Axes limits must be defined.'])
end
...
set(ud.XYLine,'XData',0,'YData',0,'XData',0,'YData',0);
ud.XData = [];
ud.YData = [];
ud.Y2Data = [];
