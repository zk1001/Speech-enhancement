...
%   cstr1      - Data for training the continuous stirred tank reactor model
%   cstr2      - Additional data for training the continuous stirred tank reactor model
%   cstr3      - Additional data for training the continuous stirred tank reactor model
...
%   cstr          - Model of the continuous stirred tank reactor.
...
%   robotref      - Reference model used in the model reference control example mrefrobotarm and mrefrobotarm2.
%
