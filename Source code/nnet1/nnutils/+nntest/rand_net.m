...
%
%  Generates a random neural network for testing purposes.
%
%  The networks generated by this function include:
%  * Random number of inputs, layers and outputs
%  * Random connections from inputs to layers
%  * Random connections from layers to layers
%  * Random presence of biases
%  * Randomly chosen processing, weight, net input, transfer functions
%  * Randomly chosen performance function and parameters
%  * Randomly restricts random function choices to ensure that GPU
%    and Simulink compatible networks are generated.
%  * Random delays for input/layer weights for dynamic networks
...
switch netKind
  ...
  case 3, simFcns = nnDependency.simulinkFcns;
          temp = nnMATLAB.netFcns;
          simFcns.performFcns = temp.performFcns;
