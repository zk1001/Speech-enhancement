...
%
% This function takes a network and data, tests the derivatives of each
% module function in the network, and returns:
%
%   numericProblems = cell array of strings describing numerical problems
%   analyticalProblems = cell array of strings describing analytical problems
%   discont = cell array of strings describing known discontinuities
%   ignore = cell array of strings describing other known problems
%   maxderiv = the maximum derivative found during the testing
...
disp(' ')
if isempty([numericProblems analyticProblems discont ignore])
  disp('PASSED.')
